        ...
        <div className="mb-3 grid gap-2 md:grid-cols-[minmax(0,1.4fr)_minmax(0,1.1fr)] text-[11px]">
          ...
          <div className="flex flex-col justify-between gap-2">
            <p className="rounded-2xl bg-slate-900/80 px-3 py-2 text-[10px] text-slate-400">
              Upload from your device by placing the file in a cloud drive (e.g.
              Google Drive, OneDrive) and pasting the shareable link here. Your
              classmates in the chosen section will see it instantly.
            </p>
            <Button
              type="button"
              size="lg"
